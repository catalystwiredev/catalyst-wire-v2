...
interface Catalyst { Ticker?: string; ticker?: string; EventType?: string; type?: string; Description?: string; description?: string; Verdict?: string; verdict?: string; ImpactScore?: number; impactScore?: number; }
interface NewsItem  { uuid: string; title: string; url: string; source: string; sentiment: string; sentiment_score: number; }
interface MacroItem { id: string; title: string; value: number | null; units: string; date: string; }
